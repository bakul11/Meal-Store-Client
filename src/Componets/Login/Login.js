...
import logPhoto from '../../images/SignUp/sign3.png';
                ...
                <div className="col-lg-5 offset-lg-1">
                    <Slide left>
                        <div className="card p-3 shadow-lg mt-5">
                            ...
                            <p className="text-center mt-3 fs-6">Don't have a account? <Link to='/register' className="text-primary">Register</Link></p>
                        </div>
